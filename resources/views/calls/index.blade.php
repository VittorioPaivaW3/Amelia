<x-app-layout>
    ...
    @php
        ...
        $currentSector = $filterSector ?? 'all';
        $currentMeta = $sectorMeta[$currentSector] ?? $sectorMeta['all'];
    @endphp
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="admin-filter-row">
                        <div>
                            ...
                            <div class="admin-filter-sub">Busque por periodo, ID ou setor</div>
                        </div>
                        <form method="GET" action="{{ route('calls.index') }}" class="admin-filter-form">
                            ...
                            <div class="admin-select" x-data="{ open: false, value: '{{ $currentSector }}', label: '{{ $currentMeta['label'] }}', sub: '{{ $currentMeta['sub'] }}' }" @keydown.escape.window="open = false">
                            ...
                            <a href="{{ route('calls.index') }}" class="admin-filter-button">Limpar</a>
                        </form>
                    </div>

                    @include('partials.requests-menu', ['requests' => $requests, 'role' => $role])
                </div>
            </div>
        </div>
    </div>
